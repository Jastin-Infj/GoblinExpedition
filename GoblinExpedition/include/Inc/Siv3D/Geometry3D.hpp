...
namespace s3d
{
	namespace Geometry3D
	{
		...
		bool Intersect(const ViewFrustum& a, const Vec3& b);
		bool Intersect(const ViewFrustum& a, const Sphere& b);
		bool Intersect(const ViewFrustum& a, const Box& b);
		bool Intersect(const ViewFrustum& a, const ViewFrustum& b);
		bool Intersect(const ViewFrustum& a, const Triangle3D& b);

		bool Intersect(const Vec3& a, const ViewFrustum& b);
		bool Intersect(const Sphere& a, const ViewFrustum& b);
		bool Intersect(const Box& a, const ViewFrustum& b);
		bool Intersect(const Triangle3D& a, const ViewFrustum& b);

		bool Contains(const ViewFrustum& a, const Vec3& b);
		bool Contains(const ViewFrustum& a, const Sphere& b);
		bool Contains(const ViewFrustum& a, const Box& b);
		bool Contains(const ViewFrustum& a, const ViewFrustum& b);
		bool Contains(const ViewFrustum& a, const Triangle3D& b);

		bool Contains(const Sphere& a, const ViewFrustum& b);
		bool Contains(const Box& a, const ViewFrustum& b);
	}
}
