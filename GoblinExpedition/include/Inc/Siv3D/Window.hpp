...
namespace s3d
{
	...
	namespace Window
	{
		...
		/// なし
		/// </returns>
		void Resize(int32 width, int32 height, bool centering = true);
		...
		/// なし
		/// </returns>
		void Resize(const s3d::Size& size, bool centering = true);
		...
		void SetBaseSize(int32 width, int32 height);
