...
namespace s3d
{
	...
	protected:
		...
		Texture(const _shadow&, const Size& size, TextureFormat format, TextureFormat render, TextureFormat sample);
	...
	public:
		...
		const RectF drawVFlipped(const Vec2& pos, const Color& diffuse = Palette::White) const;
