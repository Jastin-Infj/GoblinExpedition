...
namespace s3d
{
	...
	namespace Graphics3D
	{
		...
		void SetRasterizerStateShadow(const RasterizerState& rasterizerState);
		...
		//bool BeginVSShadow(const VertexShader& vs);
		...
		//bool BeginPSShadow(const PixelShader& vs);
		...
		void SetShadowLight(const ShadowLight& shadowLight);

		bool SetShadowMapResolution(uint32 size);
