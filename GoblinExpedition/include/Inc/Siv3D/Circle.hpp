...
#pragma warning(default:4201)
		...
		/// *this
		/// </returns>
		const Circle& drawPie(double startAngle, double angle, const Color& color = Palette::White) const;
		...
		/// *this
		/// </returns>
		const Circle& drawArc(double startAngle, double angle, double innerThickness = 1.0, double outerThickness = 0.0, const Color& color = Palette::White) const;
