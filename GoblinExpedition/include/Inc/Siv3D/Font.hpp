...
namespace s3d
{
	...
	public:
		...
		{
			return writeAt(image, text, pos, color, lineHeight);
		}
		...
		{
			return overwriteAt(image, text, pos, color, lineHeight);
		}
		...
		{
			return drawAt(text, pos, color, lineHeight);
		}
	...
	public:
		...
		{
			return writeAt(image, pos, color, lineHeight);
		}
		...
		{
			return overwriteAt(image, pos, color, lineHeight);
		}
		...
		{
			return drawAt(x, y, color, lineHeight);
		}
		...
		{
			return drawAt(pos, color, lineHeight);
		}
	};
