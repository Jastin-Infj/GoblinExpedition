...
namespace s3d
{
	...
	public:
		...
		Polygon cloneTransformed(double s, double c, const Vec2& pos) const;
		...
		void drawTransformed(double s, double c, const Vec2& pos, const Color& color = Palette::White) const;
